...
-- ============================================================
-- RATE LIMITS TABLE (serverless-safe, DB-backed rate limiting)
-- ============================================================
...
-- Atomic check-and-increment. Returns TRUE if within limit, FALSE if blocked.
-- Called via service_role (createAdminClient) from API route handlers.
